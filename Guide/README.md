...
Pour optimiser sa CG (carte graphique) AMD, la première étape est d'utiliser le logiciel [DDU](https://www.wagnardsoft.com/forums/viewforum.php?f=5) pour supprimer complètement son pilote graphique actuel et réinstaller la dernière version proprement de 0.
...
- Evitez les optimisations. Malgré les promesses de gain de performances, d'input lag ou de stabilité, dans 99% des cas, il s'agit de bêtises qui vont vous flinguer Windows complètement, ou vous faire perdre des fonctionnalités pour ne rien gagner. Si ça vous amuse de bidouiller et que ça vous dérange pas de réinstaller Windows tous les mois, vous pouvez tenter l'aventure. Sauvegardez vos données, et soyez prêts à perdre du temps.
- Evitez les logiciels de nettoyage. Les Ccleaner, Iobit SystemCare, Glary utilities, DriversCloud, DriverBooster, etc etc, c'est des saloperies. Ils vendent du vent et ne vont rien faire de bien sur votre PC. Pour nettoyer les fichiers, le nettoyage de disque intégré à Windows est efficace et moins dangereux que ces outils.
- Gardez votre PC à jour. Ca inclut Windows, les applications, les jeux et tout ce qui est sur le PC. N'allez pas forcément installer toutes les mises à jour de tout à l'instant de leur sortie, mais une fois qu'une mise à jour de quelque chose a une semaine, vous pouvez l'installer sans problème.
...
- Evitez les cracks. Essayez d'utiliser des alternatives gratuites, c'est souvent possible et bien moins dangereux. Le site [AlternativeTo](https://alternativeto.net/) peut vous aider à trouver des alternatives à tous les logiciels.
